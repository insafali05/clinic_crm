                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="{{ url('branchadmin/add_leads') }}"><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Add Lead</a>
                                    </li>
                                    <li><a href="{{ url('branchadmin/leads_list') }}"><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Manage
                                            Leads</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="{{ url('branchadmin/doctors_list') }}">
                            ...
                            <li>
                                <a href="{{ url('branchadmin/staffs_list') }}">
                                    <i class="icon-Settings-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                    <span>Staff</span>
                                </a>
