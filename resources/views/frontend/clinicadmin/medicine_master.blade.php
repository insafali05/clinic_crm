                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Medicine Department">
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Medicine Department </h5>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-label">Medicine Department</label>
                                            <input type="text" class="form-control" placeholder="Medicine Department">
                                        </div>
                                    </div>
